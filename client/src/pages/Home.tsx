...
import { ArrowDownRight, ArrowRight, CalendarDays, CheckCircle2, CircleAlert, FileImage, FolderClock, Loader2, Sparkles } from "lucide-react";
...
export default function Home() {
  ...
  const { project, summary, latestUpdate, weeklyProgress, recentUpdates, pages, attentionPages, versions } = dashboard.data;
